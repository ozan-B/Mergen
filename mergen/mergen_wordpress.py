...
""").split("\n")
    ...
    try:
        ...
        url = input(Fore.RED+"└──╼ WP/"+Fore.GREEN+"Get-Plugins"+"$     ").lower()
        ...
        s2 = requests.get("https://"+url+"/wp-content/plugins/")
        if s.status_code == 404 or s.status_code == 500 or s2.status_code == 404 or s2.status_code == 500:
    ...
    for plus in pl:
        time.sleep(0.1)
        try:
            r = requests.get('http://'+url+'/wp-content/plugins/'+plus)# burayı ve 1042 ve 1045. satırları https yaparak ta deneyebilirsin.
    ...
    '''wpplug() fonksiyonu, belirli bir WordPress sitesinde bulunan eklentileri kontrol etmek için kullanılır. Kullanıcıdan bir URL alır, bu URL'nin bir WordPress sitesi olup olmadığını 
    kontrol eder ve ardından belirli bir listedeki eklentileri tarar.
    Her eklenti için URL oluşturur ve HTTP isteği gönderir. Eğer istek 200 kodu dönerse, o eklentinin bulunduğunu belirten bir çıktı verir. Aksi halde eklentinin bulunmadığını belirten bir çıktı verir.'''
...
def user():
    try:
        print(Fore.GREEN+" [+] Please Enter WordPress URL\n")
        print(Fore.RED+" [!] Please Do Not Include Http\n")
        Url = input(Fore.RED+"└──╼ WP/"+Fore.GREEN+"Get-Username"+"$     ").lower()
    ...
    '''user() fonksiyonu ise, bir WordPress sitesindeki mevcut kullanıcı adlarını listelemek için kullanılır. Kullanıcıdan bir URL alır, URL'nin 
    bir WordPress sitesi olup olmadığını kontrol eder, ardından kullanıcı adlarını elde etmek için wp-json/wp/v2/users/ endpoint'ine bir istek gönderir.
    Dönen sonuçları işler ve kullanıcı adlarını listeler.'''
...
def main_func():
    print(Fore.YELLOW+" 1-Scan wordpress plugin")
    print(Fore.YELLOW+" 2-Scan usernames\n")

    option = input(Fore.BLUE+"Bririni seçiniz:   ")
    print("\n")
