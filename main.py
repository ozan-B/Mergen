...
def infolist2():
    ...
    while True:
        ...
        if op == "1":
            ...
            while True:
                os.system('clear')
                os.system("./mergen/mergen_IMGexif.sh") # Error
                user_input = back()
                if user_input == 'b' or user_input == 'B':
                    os.system('clear')
                    break
            ...
            while True:
                os.system('clear')
                os.system("python3 mergen/mergen_IPF.py") # Error
                user_input = back()
                if user_input == 'b' or user_input == 'B':
                    os.system('clear')
                    break
            ...
            while True:
                os.system('clear')
                os.system("python3 mergen/mergen_Ph.py") # Error
                user_input = back()
                if user_input == 'b' or user_input == 'B':
                    os.system('clear')
                    break
            ...
            while True:
                os.system('clear')
                os.system("python3 mergen/mergen_Reverse_Ip.py") # Error
                user_input = back()
                if user_input == 'b' or user_input == 'B':
                    os.system('clear')
                    break
            ...
            while True:
                os.system('clear')
                os.system("python3 mergen/mergen_Robots.py") # Error
                user_input = back()
                if user_input == 'b' or user_input == 'B':
                    os.system('clear')
                    break
            ...
            while True:
                os.system('clear')
                os.system("python3 mergen/mergen_cms_detect.py") # Error
                user_input = back()
                if user_input == 'b' or user_input == 'B':
                    os.system('clear')
                    break
            ...
            while True:
                os.system('clear')
                os.system("python3 mergen/mergen_wordpress.py") # Error
                user_input = back()
                if user_input == 'b' or user_input == 'B':
                    os.system('clear')
                    break
            ...
            while True:
                os.system('clear')
                os.system("python3 mergen/mergen_admin_panel_finder.py") # Error
                user_input = back()
                if user_input == 'b' or user_input == 'B':
                    os.system('clear')
                    break
